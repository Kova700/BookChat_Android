...
import com.example.bookchat.ui.search.adapter.booksearch.SearchResultBookDetailDataAdapter
import com.example.bookchat.ui.search.adapter.booksearch.SearchResultBookDummyAdapter
import com.example.bookchat.ui.search.adapter.chatroomsearch.SearchChatRoomDetailAdapter
import com.example.bookchat.ui.createchannel.MakeChatRoomSelectBookDialog
import com.example.bookchat.ui.search.SearchFragment.Companion.EXTRA_CHAT_SEARCH_FILTER
import com.example.bookchat.ui.search.SearchFragment.Companion.EXTRA_NECESSARY_DATA
import com.example.bookchat.ui.search.SearchFragment.Companion.EXTRA_SEARCH_PURPOSE
import com.example.bookchat.ui.search.SearchTapResultFragment.Companion.DIALOG_TAG_SEARCH_BOOK
import com.example.bookchat.ui.search.SearchTapResultFragment.Companion.DIALOG_TAG_SELECT_BOOK
		...
		searchResultBookDetailDataAdapter.loadStateFlow.collectLatest { loadState ->
			if (loadState.append.endOfPaginationReached) {
				searchResultBookDummyAdapter.dummyItemCount =
					BookImgSizeManager.getFlexBoxDummyItemCount(searchResultBookDetailDataAdapter.itemCount)
