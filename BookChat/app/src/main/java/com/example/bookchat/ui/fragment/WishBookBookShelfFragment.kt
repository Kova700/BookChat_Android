...
import com.example.bookchat.ui.adapter.bookshelf.wish.WishBookShelfDataAdapter
import com.example.bookchat.ui.adapter.bookshelf.wish.WishBookShelfDummyDataAdapter
import com.example.bookchat.ui.adapter.bookshelf.wish.WishBookShelfHeaderAdapter
...
class WishBookBookShelfFragment : Fragment() {
    ...
    private fun observeWishBookCount() = lifecycleScope.launch {
        bookShelfViewModel.wishBookTotalCount.collect { wishBookCount ->
            ...
            wishBookShelfDummyDataAdapter.dummyItemCount = BookImgSizeManager.getFlexBoxDummyItemCount(wishBookCount)
