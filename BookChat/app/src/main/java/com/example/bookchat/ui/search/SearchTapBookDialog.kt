...
import com.example.bookchat.ui.search.SearchTapBookDialogViewModel.SearchTapDialogEvent
...
class SearchTapBookDialog(private val book: Book) : DialogFragment() {
	...
	override fun onCreateView(
		...
		binding =
			DataBindingUtil.inflate(inflater, R.layout.dialog_search_tap_book_clicked, container, false)
		with(binding) {
