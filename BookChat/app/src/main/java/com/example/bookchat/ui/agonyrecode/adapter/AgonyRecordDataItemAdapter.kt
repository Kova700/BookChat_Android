...
import com.example.bookchat.ui.SwipeHelperCallback.Companion.SWIPE_VIEW_PERCENT
...
import com.example.bookchat.ui.agonyrecode.AgonyRecordViewModel
...
import com.example.bookchat.ui.agonyrecode.AgonyRecordViewModel.PagingViewEvent

class AgonyRecordDataItemAdapter(private val agonyRecordViewModel: AgonyRecordViewModel) :
    PagingDataAdapter<AgonyRecordDataItem, AgonyRecordDataItemAdapter.AgonyRecordDataItemViewHolder>(
        AGONY_RECORD_ITEM_COMPARATOR
    ) {
