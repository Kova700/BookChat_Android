...
import com.kova700.bookchat.feature.channel.databinding.DialogChannelProfileEditBinding
import com.kova700.bookchat.util.dialog.DialogSizeManager
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class ChannelProfileEditDialog(
	private val onSelectDefaultImage: () -> Unit,
	private val onSelectGallery: () -> Unit,
) : DialogFragment() {

	private var _binding: DialogChannelProfileEditBinding? = null
	...
	override fun onCreateView(
		...
		_binding = DialogChannelProfileEditBinding.inflate(inflater, container, false)
		return binding.root
	}
