...
import com.kova700.bookchat.feature.search.databinding.DialogInvalidChannelNoticeBinding
import com.kova700.bookchat.util.dialog.DialogSizeManager
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class InvalidChannelNoticeDialog : DialogFragment() {

	private var _binding: DialogInvalidChannelNoticeBinding? = null
	...
	override fun onCreateView(
		...
		_binding = DialogInvalidChannelNoticeBinding.inflate(inflater, container, false)
		return binding.root
	}
